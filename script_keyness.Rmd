...
more_stops <-c("randall", "kate", "dr", "president", "int", "oglethorpe", "jason", "brie", "orlean", "page", "said", "also", "so", "does", "it's", "our", "not", "are", "on", "at", "kinda", "every", "any", "leonardo", "dicaprio", "leo", "uh", "i've", "am", "yes", "cont'd", "okay", "oh", "isherwill", "mindy", "bremmer", "dibiasky", "june", "calder", "i'm", "was")
